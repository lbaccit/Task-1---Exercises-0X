    ...
    for y in range(alto):
        for x in range(ancho):
            ...
            resultado[indice_actual] = maximo
                ...
                #resultado[indice_actual] = 0
    return resultado
def exercise_04a_opening(i, input_path, output_path):
    ...
    erosionada = erosion(pixels, ancho, alto, i)
...
if __name__ == "__main__":
    ...
    exercise_04a_opening(i, input_path, output_path)
    #img = iio.imread("salida.pgm")
    #img2 = iio.imread("immed_gray_inv_20051123_ope2.pgm")
