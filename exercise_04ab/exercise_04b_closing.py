...
def exercise_04b_closing(i, input_path, output_path):
    ...
    # Luego erosión
    cerrada = erosion(dilatada, ancho, alto, i)
...
if __name__ == "__main__":
    ...
    exercise_04b_closing(i, input_path, output_path)
    #img = iio.imread("salida.pgm")
    #img2 = iio.imread("immed_gray_inv_20051123_clo1.pgm")
